...
ggplot(df_flu_aligned, aes(x = date_aligned, y = Incidence)) +
  ...
  theme_bw() +
  theme_mod_rotate_x_axis_labels(angle = 10) +
  # theme(axis.text.x = element_text(angle = -30, vjust = 0.4, hjust = 0, margin = margin(t = 2))) +
  # theme(axis.text.x = element_text(angle = -45, vjust = 0.4, hjust = 0, margin = margin(t = 5))) +
  # theme(axis.text.x = element_text(angle = -45, vjust = 0.4, margin = margin(t = -3))) +
  # theme(axis.text.x = element_text(angle = -90, vjust = 0.4, hjust = 0, margin = margin(t = 0))) +
