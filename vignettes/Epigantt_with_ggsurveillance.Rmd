---
title: "How to create epigantt charts in ggpplot with ggsurveillance"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to create epigantt charts in ggpplot with ggsurveillance}
...
outbreaks::varicella_sim_berlin |>
  ...
  geom_epigantt(aes(xmin = arrival, xmax = leave, colour = center)) +
...
ggplot(outbreaks::measles_hagelloch_1861, aes(y = case_ID, xmin = date_of_prodrome, xmax = date_of_rash, fill = class)) +
  ...
  scale_x_date(date_breaks = "4 weeks", date_labels = "W%U'%g") +
  theme_bw()
```
